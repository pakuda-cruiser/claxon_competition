...
class DataTransformer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        # X['Category'] = X['location'].apply(lambda x: 2 if x in [
        #     'Karoi', 'Hwange', 'Chiredzi', 'Gokwe', 'Shurugwi', 'Victoria Falls'] 
        #     else 0 if x in ['Nyanga', 'Chivhu', 'Kadoma', 'Marondera', 'Gweru', 'Masvingo', 'Harare', 'Bulawayo', 'Mutare'] 
        #     else 1)
